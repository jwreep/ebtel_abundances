...
All of the tools used to produce this paper are open-source.  At the time of writing, the implementation into \texttt{ebtel++} is publicly available as an unmerged pull request on GitHub: \url{https://github.com/rice-solar-physics/ebtelPlusPlus/pull/87}.  
